...
export default function UpdateScreenOne({route, navigation}) {
    ...
    const { uid, utaskTitle, udate, ulocation, uname, udescription } = route.params;
            ...
            <View style={styles.container} >
                ...
                <View style={styles.dateContainer}>
                    ...
                    <View style={styles.inputContainer}>
                        <TextInput
                            ...
                            value={startDate ? startDate : udate}
                            onPressIn={() => {
                ...
                <View style={styles.locationContainter}>
                    <Text style={styles.taskTitle}>
                     ...
                     <View style={styles.inputContainer}>
                        <TextInput
                            ...
                            value={location ? location : ulocation}
                            onPressIn={() => {
                    ...
                    <TouchableOpacity 
                        style={styles.button}
                        activeOpacity={0.40}
                        onPress={() => {navigation.navigate('UpdateTwo', {
                            utaskTitle: utaskTitle,
                            udate: startDate ? startDate : udate,
                            ulocation: location ? location : ulocation,
                            uname: uname,
